...
export function LeadModal({ isOpen, onClose, refId, isEmailMode }: LeadModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isEmailMode) {
      ...
      window.open(`https://wa.me/552123420050?text=${mensagem}`, '_blank');
      onClose();
    }
  };
        ...
        <div className="p-8">
          {isEmailMode ? (
            ...
            <div className="space-y-4">
              ...
              <a href="tel:+552123420050" className="w-full bg-[#0A2540] text-white py-6 rounded-2xl font-black uppercase flex items-center justify-center gap-3 hover:scale-[1.02] transition-transform shadow-xl">
